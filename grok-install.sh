#!/bin/bash
#
# Grok CLI installer â€” https://x.ai/cli/install.sh
#
...
# JSON field extractor â€” extract a top-level string value using sed.
json_get() {
...
case "$(uname -s)" in
    Darwin) os="macos" ;;
    Linux)  os="linux" ;;
    # Git for Windows / MSYS2 / Cygwin host â€” native Windows builds
